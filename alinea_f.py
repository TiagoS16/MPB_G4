...
ax.set_title('Sensibilidade de X a k4 - BL21 (fed_batch)')
ax.legend()
plt.show()
...
ax.set_xlabel('Tempo (h)')
ax.set_title('Sensibilidade de X a umax2 - BL21 (fed_batch)')
ax.legend()
plt.show()
...
ax.set_xlabel('Tempo (h)')
ax.set_title('Sensibilidade de X a Ks3 - BL21 (fed_batch)')
ax.legend()
plt.show()
...
ax.plot(T, dx_Ks3, '--', linewidth=2,label='X_Ks3', color='orange')
ax.set_xlabel('Tempo (h)')
ax.set_title('Sensibilidades de X - BL21 (fed_batch)')
ax.legend()
plt.show()
...
ax.set_xlabel('Tempo (h)')
ax.set_title('Sensibilidade de S a k4 - BL21 (fed_batch)')
ax.legend()
plt.show()
...
ax.set_xlabel('Tempo (h)')
ax.set_title('Sensibilidade de S a umax2 - BL21 (fed_batch)')
ax.legend()
plt.show()
...
ax.set_xlabel('Tempo (h)')
ax.set_title('Sensibilidade de S a Ks3 - BL21 (fed_batch)')
ax.legend()
plt.show()
...
ax.plot(T, ds_Ks3, '--', linewidth=2,label='S_Ks3', color='orange')
ax.set_xlabel('Tempo (h)')
ax.set_title('Sensibilidades de S - BL21 (fed_batch)')
ax.legend()
plt.show()