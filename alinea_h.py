...
def fun(X):
    return [0.25 * (0 / (0.3 + 0)) * X[0] + 0.55 * (0 / (0.3 + 0)) * X[0] + 0.25 * (0 / (0.4 + 0)) * X[0] - 0.7 * X[0],
            - 4.412 * 0.25 * (0 / (0.3 + 0)) * X[1] - 22.22 * 0.55 * (0 / (0.3 + 0)) * X[1] + 0.7 * 0 - 0.7 * 0,
            8.61 * 0.55 * (0 / (0.3 + 0)) * X[2] - 9.846 * 0.25 * (0 / (0.4 + 0)) * X[2] - 0.7 * 0,
            13.21 * 0.25 * (0 / (0.3 + 0)) * X[3] - 0.7 * 0]

root = fsolve(fun, [10, 20, 15, 1])
print(root)
